...
<body>
	...
	<div class="navigation-container header" id="myHeader">
				...
				<ul>
					...
					<li>
						...
						<li><a href="CardioDoctor.php">Cardiologists</a></li>
							<li><a href="doctor.php">Dermatologists</a></li>
							<li><a href="doctor.php">Endocrinologists</a>
							<li><a href="doctor.php">Gastroenterologists</a></li>
							<li><a href="doctor.php">Gynecologists</a></li>
							<li><a href="doctor.php">Medicine doctors</a></li>
							<li><a href="doctor.php">Neurologists</a></li>
							<li><a href="doctor.php">Peditricians</a></li>
						</ul>
					</li>
		...
		<div>
		<h1 class="medicine-center">Search <span>results</span></h1>
	</div>
	<?php
		#echo "ok";
		function MedSearch($k)
		{
			echo '<p class="medicine-center-text">Medicines</p>';
			echo '<hr>';
			$k=strtoupper($k);
			$newrow=0;
			...
			if($newrow==0)
			{
				echo '<div style="text-align:center;" class="no-item">Sorry!! No medicine found :(</div>';
			}
			echo '</div>';
			echo '</div>';
		}
        function DocSearch($k)
		{
			echo '<br/>';
			echo '<p class="medicine-center-text">Doctors</p>';
			echo '<hr>';
			$k=strtoupper($k);
			$newrow=0;
			$conn = new mysqli("localhost","root", "", "medicine");
        ...
        echo'</div>';
			...
			while($row=mysqli_fetch_array($result))
			{
			  if($newrow1%4==0 and $newrow1!=0)
			  {
				  echo '</div>';
				  echo '<div class="card-group">';
			  }
              $s=strtoupper($row['DocName']);
			  if(($newrow%4==2 && $newrow-$newrow1<3) || ($newrow%4==1 && $newrow-$newrow1<2))
			  {
				if((strpos($s,$k))!==FALSE)
				  {
	                $newrow1++;
        ...
        echo'</div>';
			...
			{
				echo '<div style="text-align:center;" class="no-item">Sorry!! No doctor found :(</div>';
			}
			echo '</div>';
			echo '</div>';
		}
